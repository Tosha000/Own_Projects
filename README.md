Linear_regression- с нуля написанная программа для построения регрессинной прямой для целевой переменной и одного признака на основе одного из 2 методов: 
